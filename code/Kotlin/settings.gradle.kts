...
fun DependencyResolutionManagement.buildVersionCatalogs() {
    versionCatalogs {
        ...
        fileTree(path).forEach { file ->
            val baseName = file.name.removeSuffix(tomlSuffix)
 ...
 * feature
 ****************************************/
include(":libs:feature:tts:core")
include(":libs:feature:tts:engine:azure")
include(":libs:feature:tts:processor")
include(":libs:feature:media")
...
//include(":workspace-reader:reader-compose")
