...
fun <V : View> DialogEx.bindView(id: Int)
        : ReadOnlyProperty<DialogEx, V> = required(id, viewFinder)

fun <V : View> PopupWindow.bindView(id: Int)
        : ReadOnlyProperty<PopupWindow, V> = required(id, viewFinder)

fun <V : View> PopupWindowEx.bindView(id: Int)
        : ReadOnlyProperty<PopupWindowEx, V> = required(id, viewFinder)
...
fun <V : View> View.bindNullableView(id: Int)
        : ReadOnlyProperty<View, V?> = optional(id, viewFinder)

fun <V : View> Activity.bindNullableView(id: Int)
        : ReadOnlyProperty<Activity, V?> = optional(id, viewFinder)

fun <V : View> Dialog.bindNullableView(id: Int)
        : ReadOnlyProperty<Dialog, V?> = optional(id, viewFinder)

fun <V : View> SupportDialogFragment.bindNullableView(id: Int)
        : ReadOnlyProperty<SupportDialogFragment, V?> = optional(id, viewFinder)

fun <V : View> SupportFragment.bindNullableView(id: Int)
        : ReadOnlyProperty<SupportFragment, V?> = optional(id, viewFinder)

fun <V : View> ViewHolder.bindNullableView(id: Int)
...
private val Dialog.viewFinder: Dialog.(Int) -> View?
    get() = { findViewById(it) }
private val DialogEx.viewFinder: DialogEx.(Int) -> View?
    get() = { uiView?.findViewById(it) }
private val PopupWindow.viewFinder: PopupWindow.(Int) -> View?
    get() = { contentView.findViewById(it) }
private val PopupWindowEx.viewFinder: PopupWindowEx.(Int) -> View?
    get() = { contentView.findViewById(it) }
...
private fun <T, V : View> required(id: Int, finder: T.(Int) -> View?) = BindLazy { t: T, desc ->
    t.finder(id) as V? ?: viewNotFound(id, desc)
}

@Suppress("UNCHECKED_CAST")
private fun <T, V : View> optional(id: Int, finder: T.(Int) -> View?) =
    BindLazy { t: T, _ -> t.finder(id) as V? }

@Suppress("UNCHECKED_CAST")
private fun <T, V : View> required(ids: IntArray, finder: T.(Int) -> View?) = BindLazy { t: T, desc ->
    ids.map {
...
private fun <T, V : View> optional(ids: IntArray, finder: T.(Int) -> View?) =
    BindLazy { t: T, _ -> ids.map { t.finder(it) as V? }.filterNotNull() }