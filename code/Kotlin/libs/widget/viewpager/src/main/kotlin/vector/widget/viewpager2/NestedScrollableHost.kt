 ...
 */
open class NestedScrollableHost @JvmOverloads constructor(
    ...
    private fun handleInterceptTouchEvent(e: MotionEvent) {
        ...
        if (e.action == MotionEvent.ACTION_DOWN) {
            ...
            val dx = e.x - initialX
            val dy = e.y - initialY
            val isVpHorizontal = orientation == androidx.viewpager2.widget.ViewPager2.ORIENTATION_HORIZONTAL
