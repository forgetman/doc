...
class Book {
    ...
    class UiVariable internal constructor() {

        val statusVisible = Live(false)

        /**
         * 当前阅读的章节下标
         */
        val currReadIndex = Live("待更新")

        /**
         * 当前阅读的章节进度
         */
        var currReadProgress = Live("0%")

        /**
         * 是否有新章节
         */
        val hasNewChapters = Live(false)

        /**
         * 是否正在更新
         */
        val updateState = Live(false)

        val transformation = ImageTransformation.Shape.RoundCorner(R.dimen.radius.dimenRes.toPx())
    }
}
