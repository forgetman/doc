...
public class DataTemplateSample {
    ...
    public void setMqttActionCallback(TXMqttActionCallBack mqttActionCallBack) {
        mMqttActionCallBack = mqttActionCallBack;
    }

    public void setDownStreamCallback(TXDataTemplateDownStreamCallBack downStreamCallBack) {
        mDownStreamCallBack = downStreamCallBack;
    }
    ...
    public void connect() {
        ...
        if (mDevPSK != null && !mDevPSK.isEmpty()) {
