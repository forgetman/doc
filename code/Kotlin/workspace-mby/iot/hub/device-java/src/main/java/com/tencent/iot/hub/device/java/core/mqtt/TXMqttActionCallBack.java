...
public abstract class TXMqttActionCallBack {
     ...
     */
    public abstract void onConnectCompleted(Status status, boolean reconnect, @Nullable Object userContext, @NonNull String msg, @Nullable Throwable cause);
     ...
     * @param cause 连接断开原因
     */
    public abstract void onConnectionLost(@NonNull Throwable cause);
     ...
     */
    public abstract void onDisconnectCompleted(Status status, @NonNull Object userContext, @NonNull String msg, @Nullable Throwable cause);
