    ...
    private void init() {
        ...
        mMqttActionCallBack = new TXMqttActionCallBack() {
            ...
            public void onConnectCompleted(Status status, boolean reconnect, @Nullable Object userContext, @NonNull String msg, Throwable cause) {
                ...
                try {
                    if (userContext instanceof Long) {
                        mMqttActionListener.onConnectCompleted(status.name(), reconnect, (Long) userContext, msg);
                    }
                } catch (RemoteException e) {
            ...
            public void onDisconnectCompleted(Status status, @NonNull Object userContext, @NonNull String msg, Throwable cause) {
                ...
                try {
                    if (userContext instanceof Long) {
                        mMqttActionListener.onDisconnectCompleted(status.name(), (Long) userContext, msg);
                    }
                } catch (RemoteException e) {
